function (doc) {
  ...
  emit(doc._id, {name: datainfo.Name, length: rawtext.length, readme: txt.substr(0, 256), info: datainfo, subj: subjlist, modality: modalitylist, aisummary: nj.AISummary ? nj.AISummary : '', version: nj.Version ? nj.Version : '', label: nj.VersionLabel ? nj.VersionLabel : (nj.Version ? nj.Version : ''), exact: nj.VersionExact ? true : false, baseversion: nj.BaseVersion ? nj.BaseVersion : '', commitsahead: (nj.CommitsAhead === 0 || nj.CommitsAhead) ? nj.CommitsAhead : null, fingerprint: nj.Fingerprint ? nj.Fingerprint : '', commit: nj.SourceCommit ? nj.SourceCommit : '', files: nj.Files ? nj.Files : 0, bytes: nj.Bytes ? nj.Bytes : 0});
}